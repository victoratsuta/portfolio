                    ...
                    <div style={style.inner} className={'WellHome__inner'}>
                        <div className={'WellHome__technologis'}>
                            ...
                            <div className ={'WellHome__Description'}>
                                <p>
                                    Development of of a closed CRM system for the automation of business processes in the company engaged in the sale of real estate - <b><a href={'http://www.welhome.ru/'} target={'blank'}>Welhome</a></b>,
                                based on SugarCRM. Designing the database and system architecture. Integration with existing enterprise systems.
                                </p>
                            </div>
                            <div className={'WellHome__arrow WellHome__arrow_hide'} onClick={this.animateWellhome.bind(this)}></div>
                        </div>
                        ...
                        <div className={'WellHome__logo_container'} >
                            ...
                            <p style={style.paragraph} className={'WellHome__paragraph'}>CRM system for auto-business processes</p>
                            <div className={'WellHome__arrow WellHome__arrow_show'} onClick={this.animateWellhome.bind(this)}></div>
                        </div>
                    </div>
